...
public class AccountController {
    ...
    public ResponseEntity<Account> createAccount(HttpServletRequest request, @RequestBody Account account) {
        String email = extractEmailFromToken(request);  // Get email from the JWT token
        if (email != null) {
            Account createdAccount = accountService.createAccount(email, account);  // Create account using the extracted email
